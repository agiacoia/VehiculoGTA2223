 ...
 */
public class VehiculoGiacoiaTrombottiAndrea2223 {
    ...
    public VehiculoGiacoiaTrombottiAndrea2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoGiacoiaTrombottiAndrea2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
